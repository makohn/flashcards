...
public class StudyFrame {
    ...
    private void initInfoArea() {
        ...
        progresscircle = new JProgressCircle(20);
    ...
    private void initAnswerArea() {
        ...
        btnShowAnswer = new JButton("Antwort");
        btnShowAnswer.setBorder(BorderFactory.createLineBorder(new Color(0, 163, 204)));
        btnShowAnswer.setBackground(new Color(0, 163, 204));
        btnShowAnswer.setForeground(Color.WHITE);
        btnShowAnswer.setOpaque(true);
